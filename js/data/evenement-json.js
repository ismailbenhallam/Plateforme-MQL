const evenementsJSON = [
  ...
  //   lieu: "Fès",
  //   description:
  //     "Cérémonie de remise des diplomes Comme chaque année les étudiants de la première année MQL organisent en fin de cycle de formation une cérémonie de remise des diplomes des lauréats du master MQL promotion 2019. Cette cérémonie à caractère festif a regroupé le corps professoral de la formation, le Conseil des étudiants, et familles des lauréats et leurs amis. La cérémonie a été initié par un mot d'ouverture de M. Mohammed BELLAMLIH le Doyen de la faculté, ou il a félicité les lauréats d'avoir réussis leur formation avec brio, et l'ensemble des enseignents pour avoir assuré une formation de haut niveau permettant ainsi aux lauréats une insertion professionnelle évidente, se joint à lui dans une parole élogieuse, le coordinateur du master M. Noureddine CHENFOUR pour féliciter ses étudiants qu'il a guidés jusqu'au bout avec bienveillance et dévouement. En marge de cette manifestation, c'est tenu la présentation du master et des différents activités et évènements organisés durant ces deux années de formation, suivi par le témoignage de quelques lauréats.   Au cours de cette cérémonie, 32 lauréats de la promotion 2019, ont obtenus leurs diplômes, ce qui fait un total de 350 lauréats diplômés relevant du master MQL depuis sa création en 2007.",
  //   photos: ["photo1.jpg", "photo2.jpg", "photo3.jpg", "photo4.jpg"],
  //   photosFolder: "SRCAP2019",
  //   titleColor: "#d9323a",
  // },
  {
    nom: "Campagne de stages CGI 2020",
    genre: "Campagne de stages",
    date: "2019-11-11",
    lieu: "FSDM Fès",
    description:
      "Dans le cadre du partenariat des multinationales et le master MQL, se tiennent au sein de la FSDM, des campagnes de prospéctions de futurs jeunes diplomés en voie de réalisation du PFE. Ces campagnes de stages, qui ont pour objet d'informer les étudiants sur des offre de stages PFE rémunérés de 4 à 6 mois d'une part, et d'une autre part d'effectuer des tests psychotechniques et techniques ainsi que des entretiens RH durant la journée. Sur ce, CGI organisa une campagne de recrutement de stagiaires PFE pour l’année 2019 au profit des étudiants du master MQL. Fondé en 1976, Groupe CGI inc.est la cinquième plus importante entreprise indépendante de services en technologies de l’information et en gestion des processus d’affaires au monde. CGI, premier acteur majeur de l’IT au Maroc. 700 professionnels répartis à Casablanca, Rabat et Fès 400 CDI à pourvoir en 2017 dont une majeure proportion de jeunes diplômés 100 stages. Inauguration du nouveau Centre d’excellence à Fès fin 2016 Expertises des services applicatifs, de l’infrastructure et du support Environnements technologiques: data management, CRM, NTIC…<br/><br/>En effet, cette campagne a connu X décrochements de stages PFE par les étudiants MQL, qui aujourdh'ui font partie de l'équipe technique auprès de cette entreprise mondiale.",
    photos: [
      "photo1.jpg",
      "photo2.jpg",
      "photo3.jpg",
  ...
  {
    nom: "Campagne de stages Capgemini 2020",
    genre: "Campagne de stages",
    date: "2019-10-21",
    lieu: "FSDM Fès",
    description:
