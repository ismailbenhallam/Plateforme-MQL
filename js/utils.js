...
// returns true if a date is less than N days passed as an argument
Date.prototype.isLessThanNDays = function (n) {
  return new Date() - this < n * this.DAY_IN_MILLIS;
};

// add multiple EventListeners in a call
...
// a shortcut to get an Element by its id
const $ = (id) => document.getElementById(id);

// a shortcut to create a new Element
...
// if the location is "www.example.com#presentation", this function returns "presentation"
const getCurrentPageId = () => location.hash.slice(1);
const setCurrentPageId = (id) => (location.hash = "#" + id);
...
// a function to detect if a mobile or a tablet
